...
class ProductController extends Controller
{
   ...
   function newProduct(Request $req){
    $product=new Product;
   ...
   function updateProduct(Request $req){
    ...
    return redirect('productlist')->with('success','Proizvod uspesno izmenjen!');
   
}
   function productList(Request $req){
    if($req->session()->has('user')){
    if ($req->session()->get('user')['name']!=="Stevan Nikolic") {
        return redirect('login');
    }
    } else {
        return redirect('login');   
